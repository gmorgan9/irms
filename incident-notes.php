  ...
  <tbody>
      ...
      if($result) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <td style="display: inline-block !important;max-width: 200px !important;overflow: hidden !important;white-space: nowrap !important; text-overflow: ellipsis !important;"><?php echo $note; ?></td>
