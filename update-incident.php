...
session_start();
    ...
    if (isset($_POST['update'])) {
        ...
        // Update Statement
        $update = "UPDATE incidents SET inc_num='$inc_num',priority='$priority',description='$description',assign_group='$assign_group',kb_article='$kb_article',time='$time' WHERE id='1'";
        // if(count($_POST)>0) {
