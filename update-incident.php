...
session_start();
    ...
    if (isset($_POST['update'])) {
        ...
        // Update Statement
        $sql = "UPDATE FROM `incidents` SET `inc_num`='$inc_num',`priority`='$priority',`description`='$description',`assign_group`='$assign_group',`kb_article`='$kb_article',`date`='$date',`time`='$time' HAVING id='$id'";
        // if(count($_POST)>0) {
