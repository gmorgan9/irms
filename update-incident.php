...
session_start();
    ...
    if(isset($_POST['update-incident'])) {
        ...
        $sql = "UPDATE incidents SET inc_id=$inc_id, inc_num='$inc_num', priority='$priority', description='$description', assign_group='$assign_group', kb_article='$kb_article', date='$date', time='$time'";
